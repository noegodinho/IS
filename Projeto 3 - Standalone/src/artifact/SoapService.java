 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8081/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://soap/", "SoapService");
    ...
    public Soap getSoapPort() {
        return super.getPort(new QName("http://soap/", "SoapPort"), Soap.class);
    }
    ...
    public Soap getSoapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "SoapPort"), Soap.class, features);
    }
